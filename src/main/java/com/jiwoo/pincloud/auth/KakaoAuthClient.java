...
public class KakaoAuthClient {
  ...
  public KakaoAuthClient(
    ...
    this.tokenClient = WebClient.builder().baseUrl("https://kauth.kakao.com").build();
    this.userInfoClient = WebClient.builder().baseUrl("https://kapi.kakao.com").build();
  }
  ...
  public String getAccessToken(String code) {
    ...
    try {
      ...
      log.warn(
          "Failed to get Kakao access token: status={}, body={}",
          e.getStatusCode(),
  ...
  public KakaoUserInfo getUserInfo(String accessToken) {
    try {
      ...
      log.warn(
          "Failed to get Kakao user info: status={}, body={}",
          e.getStatusCode(),
          e.getResponseBodyAsString(),
          e);
      return null;
