...
class LinkExtractServiceTest {
  ...
  @Mock private KakaoPlaceClient kakaoPlaceClient;

  @Mock private OgTagExtractor ogTagExtractor;

  @Mock private OpenAiClient openAiClient;

  @InjectMocks private LinkExtractService linkExtractService;
